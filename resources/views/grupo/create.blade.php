                ...
                <div class="col">
                    ...
                    <div class="card-header" style="background-color: #f00;">
                        <div class="d-flex align-items-center ">
                            ...
                            <p>ALTA DE COORDINADOR DE GRUPO</p>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ route('grupo.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 callout callout-danger">
                        ...
                        <div class="card-footer">
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <br>
                                    <button type="submit" class="btn btn-danger btn-block btn-flat">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </form>
